...
SELECT *, ROUND((Precio_Venta * Cantidad * (1 - Descuento_Pct)) - Costo_Envio, 2) AS Margen 
FROM FactVentas 
ORDER BY Margen ASC LIMIT 10;
...
SELECT TransaccionID, CiudadID, Descuento_Pct FROM FactVentas 
WHERE CiudadID != 6 
ORDER BY Descuento_Pct DESC LIMIT 10;
