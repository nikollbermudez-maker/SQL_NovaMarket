...
5. En "Database File", busca y selecciona el archivo `.db` de la sesión actual (ej. `02_Sesion_07/00_Base_Datos_S07.db`).
6. Haz clic en "Save Connection" y luego en "Connect".

## 3. Ejecución de Consultas
1. Abre un archivo `.sql` (ej. `02_Sesion_07/03_Laboratorio_S07.sql`).
